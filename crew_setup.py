...
# FIX 1: Completely disable OpenAI and configure for Google Gemini
os.environ["OPENAI_API_KEY"] = "NA"
os.environ["OPENAI_API_BASE"] = ""  # Clear OpenAI base URL
...
class LifeOpsCrew:
    ...
    def kickoff(self) -> Dict[str, Any]:
        ...
        # FIX 2: Pass the LLM directly to prevent CrewAI from using OpenAI
        crew = Crew(
            agents=[
                health_task.agent, 
                finance_task.agent, 
            ...
            verbose=True,
            memory=False,
            # FIX 3: Explicitly set language model to prevent OpenAI usage
            llm=self.agents.llm  # Use the Gemini LLM from agents
        )
